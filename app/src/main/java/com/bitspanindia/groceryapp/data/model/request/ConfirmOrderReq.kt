...
data class ConfirmOrderReq(
    @SerializedName("added_by_web") val addedByWeb: Int? = 0,
    ...
    @SerializedName("conv_charges") val convCharges: Double? = 0.0,
    ...
    @SerializedName("delivery_charge") val deliveryCharge: Int? = 0,
    @SerializedName("email") val email: Int? = 0,
    @SerializedName("grand_total") val grandTotal: Int? = 0,
    @SerializedName("order_id") val orderId: String? = "",
    @SerializedName("payment_mode") val paymentMode: Int? = 0,
