...
data class GetProductDetailsResponse(
    ...
    @SerializedName("multiimg") var multiimg: List<MultiImg>? = listOf(),
    @SerializedName("multiweight") var multiweight: List<MultiWeight>? = listOf(),
    @SerializedName("related") var related: MutableList<ProductData>? = mutableListOf(),
...
data class MultiWeight(
    ...
    @SerializedName("id") var sizeId: String? = "",
