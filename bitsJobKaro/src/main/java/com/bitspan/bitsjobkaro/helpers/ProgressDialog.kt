package com.bitspan.bitsjobkaro.helpers
...
import com.bitspan.bitsjobkaro.databinding.ProgressDialogeBinding
...
object ProgressDialog {
    ...
    fun show(context: Context, title: CharSequence?): Dialog {
        ...
        // Progress Bar Color
        setColorFilter(binding.cpPbar.indeterminateDrawable, ResourcesCompat.getColor(context.resources,  R.color.blue_500, null))
