...
package com.bitspan.bitsjobkaro.ui.librariesImplementation.meowBottomNav
...
import com.bitspan.bitsjobkaro.databinding.MeowNavigationCellBinding
import meow.bottomnavigation.dp
import meow.bottomnavigation.ofColorStateList
import meow.bottomnavigation.runAfterDelay
import meow.bottomnavigation.updateLayoutParams
...
class MeowBottomNavigationCell @JvmOverloads constructor(
    ...
    var titleTextColor = 0
        set(value) {
            field = value
            if (allowDraw)
                binding.tvTitle.setTextColor(if (!isEnabledCell) titleTextColor else selectedTextColor)
        }
    ...
    private var progress = 0f
        set(value) {
            ...
            binding.tvTitle.setTextColor(if (progress == 1f) selectedTextColor else titleTextColor)
