...
class MeowBottomNavigation : FrameLayout {
    ...
    var titleTextColor = Color.parseColor("#504F60")
        set(value) {
            field = value
            updateAllIfAllowDraw()
        }

    var selectedTextColor = Color.parseColor("#000000")
        set(value) {
            field = value
            updateAllIfAllowDraw()
        }
...
//        heightCell = 96.dp(context)
        heightCell = context.resources.getDimension(R.dimen.space_30).toInt()
    ...
    private fun setAttributeFromXml(context: Context, attrs: AttributeSet) {
        ...
        try {
            a.apply {
                ...
                selectedTextColor =
                    getColor(R.styleable.MeowBottomNavigation_mbn_selectedTextColor, selectedTextColor)
    ...
    fun add(model: Model) {
        ...
        cell.apply {
            ...
            selectedTextColor = this@MeowBottomNavigation.selectedTextColor
